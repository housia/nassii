...
if (window.location.href.includes('1')) {
  m1q1correct = "Disaccharide" //answers of first quiz
  m1q2correct = "Homodisaccharide"
  m1q3correct = "Reducing"
  } else if (window.location.href.includes('2')) {
    
  m1q1correct = "One"  //answers of second quiz
  m1q2correct = "Yes"
  m1q3correct = "In a binding pocket"
  ...
  m1q1correct = "Beta sheets" //answer to third quiz
  m1q2correct = "AA based fluorophore"
  m1q3correct = "Mid Sequence"
  } else if (window.location.href.includes('4')) {
  m1q1correct = "One" //answers to fourth quiz
  m1q2correct = "Yes"
  m1q3correct = "Yes"
  } else {
  m1q1correct = "Closed"
  m1q2correct = "In a binding pocket"
  m1q3correct = "Two"
  }
